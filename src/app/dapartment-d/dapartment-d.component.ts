...
@Component({
  selector: 'app-dapartment-d',
  templateUrl: './dapartment-d.component.html',
  styleUrls: ['./dapartment-d.component.css']
})
export class DapartmentDComponent implements OnInit {
  @Input() general = [];
  @Input() mushlim = [];
  @Input() women = [];
  @Input() other = [];
