...
@Component({
  selector: 'app-dapartment-a',
  templateUrl: './dapartment-a.component.html',
  styleUrls: ['./dapartment-a.component.css']
})
export class DapartmentAComponent implements OnInit {
@Input() general = [];
@Input() mushlim = [];
@Input() women = [];
@Input() other = [];
