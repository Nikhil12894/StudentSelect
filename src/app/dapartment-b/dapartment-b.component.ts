...
@Component({
  selector: 'app-dapartment-b',
  templateUrl: './dapartment-b.component.html',
  styleUrls: ['./dapartment-b.component.css']
})
export class DapartmentBComponent implements OnInit {
  @Input() general = [];
  @Input() mushlim = [];
  @Input() women = [];
  @Input() other = [];
