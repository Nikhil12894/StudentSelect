...
@Component({
  selector: 'app-dapartment-e',
  templateUrl: './dapartment-e.component.html',
  styleUrls: ['./dapartment-e.component.css']
})
export class DapartmentEComponent implements OnInit {
  @Input() general = [];
  @Input() mushlim = [];
  @Input() women = [];
  @Input() other = [];
